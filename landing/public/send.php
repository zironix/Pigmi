...
$config['smtp_username'] = 'zenoxus@yandex.ru';  //Смените на адрес своего почтового ящика.
$config['smtp_port'] = '465'; // Порт работы.
$config['smtp_host'] =  'ssl://smtp.yandex.ru';  //сервер для отправки почты
$config['smtp_password'] = 'vvpmkdydptdnqqfk';  //Измените пароль
$config['smtp_debug'] = true;  //Если Вы хотите видеть сообщения ошибок, укажите true вместо false
$config['smtp_charset'] = 'utf-8';	//кодировка сообщений. (windows-1251 или utf-8, итд)
$config['smtp_from'] = 'smarts.ooo'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
...
{
    //$to  = "1qq2ww3ee4@gmail.com" ;
    $to  = "info@smarts.ooo" ;
    $subject = "Посетитель оставил заявку - ".$_SERVER['HTTP_HOST'];
    $message = '
<html>
<head>
<title>test</title>
    ...
    smtpmail('smarts.ooo', $to, $subject, $message);
    echo 'sent';
}else{
    echo 'error1';
}

/*if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['source']))
{
    $to  = "uslada-club@yandex.ru" ;
    //$to  = "office@uslada.club" ;
    $subject = "Посетитель оставил заявку - ".$_SERVER['HTTP_HOST'];
